...
<header>
    ...
    <div class="heroe">
        ...
        <h2>Это маленький фреймворк с большими возможностями</h2>
    </div>
...
<section>
    ...
    <p>Эта страница сделана автоматически фреймворком CodeIgniter.</p>

    <p>Если выхотите подредактировать эту страницу Вы ее найдете в:</p>

    <pre><code>app/Views/welcome_message.php</code></pre>

    <p>Соответсвующие контроллер расположен в:</p>

    <pre><code>app/Controllers/Home.php</code></pre>

    <p> И по доброй традиции дадим ссылку на исходники<p>
        
    <pre><code></code><a href="https://github.com/mobilesikuda/like1c">https://github.com/mobilesikuda/like1c</a></code></pre>
